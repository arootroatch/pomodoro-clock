...
export default function Break(){
    ...
    function handleChange(){
        dispatch(setBreak(document.getElementById('break').value));
    }
    ...
    return(
        <div id='break-wrapper'>
            <label htmlFor="break" id='break-label'>Break Length</label>
            <select defaultValue="5" name="break" id="break" onChange={()=>handleChange()}>
